...
export default function Projects() {
    return(
        <div className="projects-container my-custom-proj" id="project" >
          <h1 style={{color:"#7c1777ff"}} className="h1" data-aos="">Projects</h1>
          <div class="container  my-custom">
            <div class="row text-center ">

                <div class="col col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 custom-margin" data-aos="slide-up" >
                ...
                <div class="col col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 custom-margin" data-aos="zoom-in">
